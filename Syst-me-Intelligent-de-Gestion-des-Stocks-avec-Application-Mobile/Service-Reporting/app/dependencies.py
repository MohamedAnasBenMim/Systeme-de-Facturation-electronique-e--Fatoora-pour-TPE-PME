# app/dependencies.py — service_reporting/
...
def get_all_roles(current_user: dict = Depends(get_current_user)) -> dict:
    """Accessible à tous les rôles : admin, gestionnaire, opérateur."""
    return current_user
